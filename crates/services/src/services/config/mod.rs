...
pub type ConcurrencyConfig = versions::v9::ConcurrencyConfig;
pub type ConcurrencyLimit = versions::v9::ConcurrencyLimit;
pub type QueueConfig = versions::v9::QueueConfig;
