...
fn default_git_auto_rebase_ready_attempts() -> bool {
    true
}
...
pub struct Config {
    ...
    #[serde(default = "default_git_auto_rebase_ready_attempts")]
    pub git_auto_rebase_ready_attempts: bool,
    #[serde(default)]
...
impl Config {
    fn from_v9_config(old_config: v9::Config) -> Self {
        Self {
            ...
            git_auto_rebase_ready_attempts: default_git_auto_rebase_ready_attempts(),
