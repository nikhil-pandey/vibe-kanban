...
The Vibe Kanban VSCode extension brings task management directly into your IDE, providing seamless integration with logs, diffs, and process monitoring. This extension works with VSCode (including Insiders) and popular forks including Cursor and Windsurf.
...
<Tip>
Using VS Code Insiders? Install the same Marketplace listing from within Insiders; it uses the identical extension ID.
</Tip>
</Tab>
...
| **VSCode Insiders** | ✅ Fully Supported | VSCode Marketplace |
